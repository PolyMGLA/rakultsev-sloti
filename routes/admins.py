...
async def mh_secret_get(msg: types.Message):
    """
...
async def mh_secret_regen(msg: types.Message):
    """
...
async def mh_novost(msg: types.Message, command: CommandObject):
    """
...
async def mh_spisok(msg: types.Message):
    """
...
async def mh_balance(msg: types.Message, command: CommandObject):
    """
...
async def mh_profile(msg: types.Message, command: CommandObject):
    """
...
async def mh_get_gift(msg: types.Message, command: CommandObject):
    if not command.args:
...
async def mh_remove_gift(msg: types.Message, command: CommandObject):
    if not command.args:
...
async def mh_gifts_list(msg: types.Message):
...
async def mh_find_users(msg: types.Message, command: CommandObject):
    if command.args is None:
...
async def mh_credit(msg: types.Message, command: CommandObject):
    await msg.answer(utils.credit(int(command.args), show_user=True))


@router.message(Command("credit_list"))
async def mh_credit_list(msg: types.Message):
...
async def mh_minus(msg: types.Message):
...
async def mh_exec(msg: types.Message, command: CommandObject):
...
async def mh_send_db(msg: types.Message):
    doc = types.FSInputFile("./db.db")
    await msg.answer_document(doc, caption="База данных")


@router.message(Command("exit"))
async def mh_exit(msg: types.Message, command: CommandObject):
